...
export const constantRoutes = [
...

  {
    ...
    children: [
      ...
      },
      {
        path: 'store',
        name: 'server.store',
        component: () => import('@/views/server/store'),
...

  {
    ...
    children: [
      {
        path: '',
        name: 'serverGroup.index',
        component: () => import('@/views/serverGroup/index'),
...

  {
    ...
    children: [
      ...
      },
      {
        path: 'show/:id',
        name: 'deploy.show',
        component: () => import('@/views/deploy/show'),
        meta: { title: '申请单详情' },
        hidden: true
      }
    ]
